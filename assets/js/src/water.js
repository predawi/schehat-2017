...
var CanvasSlideshow = function (options) {
  //  SCOPE
  /// ---------------------------
  var that = this
  ...
  var renderer = new AutoDetectRenderer(options.stageWidth, options.stageHeight, { transparent: true })
  var stage = new PIXI.Container()
  var slidesContainer = new PIXI.Container()
  var displacementSprite = new TextureImg(options.displacementImage)
  ...
  this.initPixi = function () {
    ...
    displacementSprite.baseTexture.wrapMode = PIXI.WRAP_MODES.REPEAT
  ...
  this.loadPixiSprites = function (sprites) {
    ...
    for (var i = 0; i < rSprites.length; i++) {
      var texture = new TextureImg(sprites[i])
...
module.exports = CanvasSlideshow